...
sudo apt install -y curl wget netcat-traditional nano git mc whois bash-completion tree
sudo apt install -y hstr libffi-dev libssl-dev jq tmux tldr fzf ripgrep bat htop zoxide yazi
...
# Install Neovim
sudo apt install -y build-essential luarocks
