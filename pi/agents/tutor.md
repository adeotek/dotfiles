...
# port: opencode's bash:ask / edit:ask prompts are not portable — Pi child permission gates need a watchdog arbiter model; the prompt keeps the describe-don't-do policy.
